...
DEFAULT_MODEL = "instruct2"
DEFAULT_SPEAKER = "yingyeyuan_female"
DEFAULT_LIMIT = 100
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="使用哪个模型；默认固定 instruct2；both 表示每条提示词随机选 instruct2 或 zero_shot",
    )
    parser.add_argument("--speaker", default=DEFAULT_SPEAKER, help="具体 spk_id；默认 yingyeyuan_female")
    parser.add_argument("--concurrency", type=int, default=CONCURRENCY, help="并发请求数")
    parser.add_argument("--limit", type=int, default=DEFAULT_LIMIT, help="只生成前 N 条提示词，0 表示不限制")
