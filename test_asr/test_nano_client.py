...
AUDIO_FILE = os.path.join(PROJECT_ROOT, "test_asr", "asr_test_audio", "123.wav")
MP3_FILE = os.path.join(PROJECT_ROOT, "test_asr", "asr_test_audio", "儿童故事 - 吉吉和磨磨.mp3")
MP4_FILE = os.path.join(PROJECT_ROOT, "test_asr", "asr_test_audio", "儿童故事 - 吉吉和磨磨.mp3")
